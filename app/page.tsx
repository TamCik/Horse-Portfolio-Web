    ...
    <main className="w-screen h-screen relative">
      <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage: "url(/main-bg.webp)"}}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
           <h1 className="lg:text-[50px] sm:text-[30px] text-white font-semibold">
           ...
           <p className="text-gray-200 hidden md:block">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum accusamus laboriosam eveniet, consectetur rerum a exercitationem. Ut soluta eveniet provident, nisi, odit deserunt quas excepturi eligendi dolore delectus praesentium ratione?
           </p>
